                ...
                <div class="relative group">
                    ...
                    <ul class="absolute left-0 hidden mt-2 space-y-2 bg-teal-600 text-white group-hover:block w-48 p-3 rounded-lg shadow-md">
                        <?php if ($user_id != '') { ?>
                            ...
                            <li><a href="components/user_logout.php" onclick="return confirm('Logout from this website?');" class="block px-4 py-2 hover:bg-teal-700 rounded-lg text-lg">Logout</a></li>
                        <?php } else { ?>
            ...
            <ul>
                ...
                <li class="relative group">
                    ...
                    <ul class="absolute left-0 hidden mt-2 space-y-2 bg-teal-600 text-white group-hover:block w-48 p-3 rounded-lg shadow-md">
                        <?php if ($user_id != '') { ?>
                            <li><a href="dashboard.php" class="block px-4 py-2 hover:bg-teal-700 rounded-lg text-lg">Dashboard</a></li>
                            <li><a href="../htdocs/components/user_logout.php" onclick="return confirm('Logout from this website?');" class="block px-4 py-2 hover:bg-teal-700 rounded-lg text-lg">Logout</a></li>
                        <?php } else { ?>
                            <li><a href="index.php" class="block px-4 py-2 hover:bg-teal-700 rounded-lg text-lg">Login now</a></li>
                        <?php } ?>
                    </ul>
                </li>
            </ul>
